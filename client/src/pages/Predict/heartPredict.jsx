    ...
    switch (predictionLevel) {
      case 'Unlikely':
        return (
          <>
            <p>
              The machine learning prediction for {patientData?.name}'s heart disease risk is unlikely.
            </p>
            <p>
              While the model suggests a low risk, it's essential to interpret this as an initial evaluation.
            </p>
            <p>
      ...
      case 'Likely':
        return (
          <>
            <p>
              The prediction for {patientData?.name}'s heart disease risk is likely.
            </p>
            <p>
